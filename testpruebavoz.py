...
preguntas ={'pregunta1': 'TIENE FRECUENTES DOLORES DE CABEZA','pregunta2': 'TIENE MAL APETITO',
            ...
            'pregunta6':'SE SIENTE NERVIOSO O TENSO','pregunta7':'SUFRE DE MALA DIGESTIÓN',
...
habla("HOLA EVER SOY UN AGENTE CONVERSACIONAL PARA TAMIZAJE PSICOLOGICO")
...
for i in preguntas:
    ...
    try:
        ...
        if respuesta =='sí' or respuesta=='no':
            ...
            habla("Las respuestas solo pueden ser (si o no)")
...
if psi <=7:
    print("Normal" )    
elif psi >=8 and psi <=14 :
    print("Leve")
elif psi >=14 and psi <=18 :
    print("Moderado")
elif psi >=19 and psi <=22 :
    print("Severo")
elif psi >=23 :
    print("Muy severo")
